...
python tools/export_model.py -c configs/det/ch_PP-OCRv4/ch_PP-OCRv4_det_cml.yml \
     -o Global.pretrained_model=./output/ch_PP-OCRv4_det/latest Global.save_inference_dir="./inference/ch_PP-OCRv4_det"
```

### 识别模型
```
python tools/export_model.py -c configs/det/ch_PP-OCRv4/ch_PP-OCRv4_rec.yml \
     -o Global.pretrained_model=./output/ch_PP-OCRv4_rec/latest Global.save_inference_dir="./inference/ch_PP-OCRv4_rec"
```
